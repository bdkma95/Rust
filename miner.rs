use {
    super::schema::miners, crate::{wallet::wallet::*, DBPooledConnection}, diesel::{
        result::Error, ExpressionMethods, Insertable, QueryDsl, Queryable, RunQueryDsl
    }, rand::Rng, serde::{
        Deserialize, 
        Serialize
    }, std::result, uuid::Uuid
};
