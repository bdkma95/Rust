        ...
        for bet in &bet_pool.bets {
            if bet.outcome == winning_outcome {
                ...
                distribute_payout(
                    ...
                    ctx.accounts.bet_pool_token_account.clone(),
...
fn distribute_payout<'a>(
    token_program: AccountInfo<'a>,
    bet_pool_token_account: AccountInfo<'a>,
    ...
    msg!("Transferring {} tokens from bet pool to user", amount);
